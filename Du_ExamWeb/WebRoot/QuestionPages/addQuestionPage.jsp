...
<html>
 ...
 <link rel="stylesheet" type="text/css" href="./css/bootstrap.min.css">
  ...
  <body>
   <h1 align="center">添加考题类型</h1>
    <hr>
    	<form id="studentCreate" action="<%=basePath %>addQuestionServlet?pageNum=1" name="form1" method="post" class="form-horizontal" onsubmit="return isValidate(form1)">
							<div class="form-group">									
									<label for="name" class="col-md-4 control-label">考题编号：</label>
								   <div class="col-md-8">
									<input type="text" class="form-control input-lg" id="name" name="qnumber" onblur="usernameCheck(form1)" /><span id="tip"></span>
								   </div>
							</div>	   
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" class="form-control input-lg" id="password" name="qname" />
									</div>
								</div>
								<div class="form-group">
