...
<html>
 ...
 <link rel="stylesheet" type="text/css" href="./css/bootstrap.min.css">
  ...
  <body>
     <h1 align="center">修改考题类型</h1>
    <hr>
  	<form id="studentCreate" action="<%=basePath %>editQuestionType2?id=${question.id}&pageNum=${pageNum}" name="form1" method="post" class="form-horizontal" onsubmit="return isValidate(form1)">
							<div class="form-group">									
									<label for="name" class="col-md-4 control-label">考题编号：</label>
								   <div class="col-md-8">
									<input type="text" class="form-control input-lg" id="name" name="qnumber" onblur="usernameCheck(form1)"  value="${question.typeCode} "/><span id="tip"></span>
								   </div>
							</div>	   
								<div class="form-group">
									...
									<div class="col-md-8">
										<input type="text" class="form-control input-lg" id="password" name="qname" value="${question.typeName} "/>
									</div>
								</div>
								<div class="form-group">
							     	<div class="col-sm-offset-2 col-md-12">
               <button type="submit" class="btn btn-success" id="register">确认修改考题类型</button>
